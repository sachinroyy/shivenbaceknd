...
exports.verifySubscription = exports.createSubscription = exports.getPlans = void 0;
...
const createSubscription = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const order = yield (0, razorpay_1.createOrder)(plan.amount, plan.currency);
        res.status(200).json({
            success: true,
            order,
...
const verifySubscription = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userId = req.user._id;
        // Verify the payment
        const isVerified = (0, razorpay_1.verifyPayment)(orderId, paymentId, signature);
        if (!isVerified) {
